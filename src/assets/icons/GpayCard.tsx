...
export default class GpayCardIcon extends Vue {
  protected render() {
    return (
      <svg
      ...
      >
        ...
        <g transform="translate(213 -305)">
          <g fill="#fff" stroke="#eee" transform="translate(-213 305)">
            <circle stroke="none" cx="16" cy="16" r="16" />
            <circle fill="none" cx="16" cy="16" r="15.5" />
          </g>
